...
<head>
	...
	<title>esgisforum | dashboard</title>
...
<svg class="feather feather-grid" stroke-linejoin="round" stroke-linecap="round" stroke-width="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="18" width="18" xmlns="http://www.w3.org/2000/svg"><rect height="7" width="7" y="3" x="3"/><rect height="7" width="7" y="3" x="14"/><rect height="7" width="7" y="14" x="14"/><rect height="7" width="7" y="14" x="3"/></svg>
				...
				<ul class="drop-menu">
				  	<li><a title="profile.html" href="profile.html"><i class="icofont-user-alt-1"></i>Profile</a></li>
					<li><a title="" href="#"><i class="icofont-question-circle"></i>Aide</a></li>
					<li><a title="" href="#"><i class="icofont-gear"></i>Parametre</a></li>
					<li><a class="dark-mod" title="" href="#"><i class="icofont-moon"></i>Mode Sombre</a></li>
					<li><a title="" href="login-register.html" class="logout"><i class="icofont-logout"></i>Deconnexion</a></li>
				</ul>
			</div>
...
<svg xmlns="http://www.w3.org/2000/svg" width="18" height="18" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-search"><circle cx="11" cy="11" r="8"></circle><line x1="21" y1="21" x2="16.65" y2="16.65"></line></svg></i></span>
	...
	<header class="">
		<div class="topbar stick">
			<div class="logo"><img alt="" src="images/OIP.jfif"><span>ESGIS</span></div>
			<div class="searches">
				<form method="post">
					<input type="text" placeholder="Recherche...">
...
<svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-grid"><rect x="3" y="3" width="7" height="7"></rect><rect x="14" y="3" width="7" height="7"></rect><rect x="14" y="14" width="7" height="7"></rect><rect x="3" y="14" width="7" height="7"></rect></svg>
					...
					<ul class="dropdown">
						<li><a href="profile.html" title=""><i class="icofont-user-alt-3"></i> Profile</a></li>
						...
						<li><a href="help-faq.html" title=""><i class="icofont-question-circle"></i> Aide</a></li>
						<li><a href="settings.html" title=""><i class="icofont-gear"></i> Parametre</a></li>
						<li><a href="privacy-n-policy.html" title=""><i class="icofont-notepad"></i> Politique d'utilisation</a></li>
						<li><a class="dark-mod" title="" href="#"><i class="icofont-moon"></i> Mode Sombre</a></li>
						<li class="logout"><a href="sign-in.html" title=""><i class="icofont-power"></i> Deconnexion</a></li>
					</ul>
				</li>
			</ul>
		</div>
...
<svg id="menu-btn" xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-menu"><line x1="3" y1="12" x2="21" y2="12"></line><line x1="3" y1="6" x2="21" y2="6"></line><line x1="3" y1="18" x2="21" y2="18"></line></svg></i>
				...
				<div class="col-lg-6 col-md-6 col-sm-6">
					<ul class="breadcrumb">
						<li><a href="login-register.html" title="">Home</a></li>
						<li><a href="login-register.html" title="">Tableau de bord</a></li>
					</ul>
				</div>
			</div>
		</div>	
		...
		<ul class="menu-slide">
			<li class="active">
				<a class="" href="login-register.html" title="">
					<i><svg id="icon-home" class="feather feather-home" stroke-linejoin="round" stroke-linecap="round" stroke-width="2" stroke="currentColor" fill="none" viewBox="0 0 24 24" height="14" width="14" xmlns="http://www.w3.org/2000/svg"><path d="M3 9l9-7 9 7v11a2 2 0 0 1-2 2H5a2 2 0 0 1-2-2z"/><polyline points="9 22 9 12 15 12 15 22"/></svg></i>Tableau de bord
				</a>
			</li>
...
<svg id="ab4" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg></i>Evenements
				</a>
			</li>-->

			<li class="">
				<a class="" href="events.html" title=""><i class="">
<svg id="ab4" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-airplay"><path d="M5 17H4a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h16a2 2 0 0 1 2 2v10a2 2 0 0 1-2 2h-1"></path><polygon points="12 15 17 21 7 21 12 15"></polygon></svg></i>Publications
				</a>
			</li>
			<!--<li class="">
...
<svg xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-coffee"><path d="M18 8h1a4 4 0 0 1 0 8h-1"></path><path d="M2 8h16v9a4 4 0 0 1-4 4H6a4 4 0 0 1-4-4V8z"></path><line x1="6" y1="1" x2="6" y2="4"></line><line x1="10" y1="1" x2="10" y2="4"></line><line x1="14" y1="1" x2="14" y2="4"></line></svg>
			...
			<li class="">
				<a class="" href="messages-inbox.html" title="">
					<i class="">
<svg id="ab2" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-message-square"><path d="M21 15a2 2 0 0 1-2 2H7l-4 4V5a2 2 0 0 1 2-2h14a2 2 0 0 1 2 2z"></path></svg></i>Commentaires
				</a>
			</li>
...
<svg id="team" xmlns="http://www.w3.org/2000/svg" width="16" height="16" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-smile"><circle cx="12" cy="12" r="10"></circle><path d="M8 14s1.5 2 4 2 4-2 4-2"></path><line x1="9" y1="9" x2="9.01" y2="9"></line><line x1="15" y1="9" x2="15.01" y2="9"></line></svg></i>Team
			...
			<li class="">
				<a class="" href="login-register.html" title="">
					<i class="">
<svg id="ab9" xmlns="http://www.w3.org/2000/svg" width="14" height="14" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-lock"><rect x="3" y="11" width="18" height="11" rx="2" ry="2"></rect><path d="M7 11V7a5 5 0 0 1 10 0v4"></path></svg></i>Connexion/Inscription
				</a>
			<!--</li>
			<li class="menu-item-has-children">
				...
				<ul class="submenu">
					...
					<li><a href="forgot-password.html" title="">Mot de passe oublie</a></li>
						...
						<div class="col-lg-4 col-md-4 col-sm-4">
							<div class="d-widget soft-red">
								...
								<div class="d-widget-content">
									...
									<h6>Mis a jour en temps reel</h6>
									<h5>223</h5>
...
<svg id="dolor-sign" xmlns="http://www.w3.org/2000/svg" width="20" height="20" viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="2" stroke-linecap="round" stroke-linejoin="round" class="feather feather-dollar-sign earning"><line x1="12" y1="1" x2="12" y2="23"></line><path d="M17 5H9.5a3.5 3.5 0 0 0 0 7h5a3.5 3.5 0 0 1 0 7H6"></path></svg>
					...
					<div class="row merged20 mb-4">
						<div class="col-lg-12">
							<div class="d-widget">
								<div class="d-widget-title">-->
									<h5>Manager les utilisateurs</h5>
								</div>
								<div class="d-widget-content">
									<table class="table manage-user table-default table-responsive-md">
										...
										<tbody>
											<tr>
												...
												<td><a class="mini-btn" href="#" title="">voir</a></td>
												<td><a class="mini-btn" href="#" title="">voir</a></td>
												<td>
		...
		<div class="popup">
			...
			<div class="popup-meta">
				<div class="popup-head">
					<h5><i class="icofont-envelope"></i> Envoyer Message</h5>
				</div>
	...
	<!--<div class="side-slide">
		...
		<div class="slide-meta">
			<ul class="nav nav-tabs slide-btns">
				 <li class="nav-item"><a class="active" href="#messages" data-toggle="tab">Commentaires</a></li>
			...
			<!--<div class="tab-content">
				...
				<div class="tab-pane fade" id="notifications" >
					...
					<a href="#" title="" class="main-btn" data-ripple="">voir tout</a>
				</div>
			</div>
		</div>
